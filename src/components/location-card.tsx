...
export function LocationCard({ photo, rating, icon, name, type, website, address, phone, key }: LocationCardProps) {

  return (
    <Card className={"grid grid-cols-2"} key={key}>
